...
<div id="sidebar">
	<div id="sidebar-wrapper">
		...
		<!-- Logo (221px wide) -->
		<img id="logo" src="<@spring.url '/assets/resource/images/logo.png'/>"
			alt="Admin Page" />
		...
		<div id="profile-links">
			...
			<form action="<@spring.url '/login/admin/logout'/>" method="post">
				<a target="_blank" href="<@spring.url '/'/>" title="View the Site">View
					the Site</a> | <a href="javascript:;" onclick="parentNode.submit();"
		...
		<ul id="main-nav">
			...
			<li><a href="<@spring.url '/login/admin' />"
			...
			<li><a href="#" class="nav-top-item"> <!-- Add the class "current" to current menu item -->
				...
				<ul>
					<li><a href="<@spring.url '/admin/addnews'/>">Add New</a></li>
					<li><a href="<@spring.url '/admin/managenews'/>">Manage
							News</a></li>
			...
			<li><a href="#" class="nav-top-item"> Pages </a>
				<ul>
					<li><a
						href="<?php echo base_url('index.php/admin/addpage'); ?>">Create
							a new Page</a></li>
					<li><a
						href="<?php echo base_url('index.php/admin/managepages'); ?>">Manage
							Pages</a></li>
				</ul></li>

			<li><a href="#" class="nav-top-item"> Categories </a>
				<ul>
					<li><a
						href="<?php echo base_url('index.php/admin/addcat'); ?>">Add
							New</a></li>
					<li><a
						href="<?php echo base_url('index.php/admin/managecats'); ?>">Manage
							Categories</a></li>
				</ul></li>

			<li><a href="#" class="nav-top-item"> Users </a>
				<ul>
					<li><a
						href="<?php echo base_url('index.php/admin/adduser'); ?>">Add
							New</a></li>
					<li><a
						href="<?php echo base_url('index.php/admin/manageusers'); ?>">Manage
							Users</a></li>
				</ul></li>
			...
			<li><a href="#" class="nav-top-item"> Settings </a>
				<ul>
					<li><a
						href="<?php echo base_url('index.php/admin/settings'); ?>">Settings</a></li>
				</ul></li>
			<li><a href="#" class="nav-top-item"> Adds </a>
				<ul>
					<li><a href="<?php echo base_url('index.php/admin/ads'); ?>">Ads</a></li>
				</ul></li>

			<li><a href="#" class="nav-top-item"> Details </a>
				<ul>
					<li><a
						href="<?php echo base_url('index.php/admin/details'); ?>">Details</a></li>
				</ul></li>
